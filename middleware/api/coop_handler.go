...
func ListCoopsHandler(c *fiber.Ctx) error {
	...
	return utils.SuccessResponse(c, fiber.StatusOK, coops, "Coops retrieved")
}
...
func CreateCoopHandler(c *fiber.Ctx) error {
	return utils.SuccessResponse(c, fiber.StatusCreated, nil, "Coop created (mock)")
}
...
func UpdateCoopHandler(c *fiber.Ctx) error {
	return utils.SuccessResponse(c, fiber.StatusOK, nil, "Coop updated (mock)")
}
...
func DeleteCoopHandler(c *fiber.Ctx) error {
	return utils.SuccessResponse(c, fiber.StatusOK, nil, "Coop deleted (mock)")
}
...
// @Router /v1/farms/{farm_id}/coops/{coop_id}/temperature [get]
