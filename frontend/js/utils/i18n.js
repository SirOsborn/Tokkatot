  ...
  (function (window) {
    ...
    const translations = {
      km: {
        ...
        /* --- FIX: New Device Translations (Bolded in image) --- */
        device_conveyor_belt: 'បង្វែរលាមក',
        device_cooling_fan:   'កង្ហារត្រជាក់',
        device_feeder_motor:  'ម៉ូទ័រទម្លាក់ចំណី',
        device_heater:        'អំពូលកម្តៅ',
        device_temp_humidity: 'សីតុណ្ហភាព/សំណើម',
        device_water_level:   'កម្រិតទឹក',
        ...
        lowest:           'ទាបបំផុត',
        at:               'នៅ',
        humidity_label:    'សំណើម',
        hot:              'ក្តៅ',
        warm:             'ក្តាច',
        neutral:          'ធម្មតា',
        cool:             'ត្រជាក់',
        loading:          'កំពុងដំណើរការ...',
        no_historical_data:'មិនមានប្រវត្តិទិន្នន័យ',
        coop:             'ទ្រុង',
        no_coop:          'គ្មានទ្រុង',
        no_farm:          'គ្មានកសិដ្ឋាន',
        no_readings_today:'មិនទាន់មានទិន្នន័យនៅឡើយទេ',
      ...
      en: {
        ...
        /* --- New Device Translations (English, bolded in image) --- */
        device_conveyor_belt: 'Conveyor Belt',
        device_cooling_fan:   'Cooling Fan',
        device_feeder_motor:  'Feeder Motor',
        device_heater:        'Heater',
        device_temp_humidity: 'Temp/Humidity',
        device_water_level:   'Water Level',
        ...
        no_coop:          'No coop',
        no_farm:          'No Farm',
        no_readings_today:'No readings yet today',
